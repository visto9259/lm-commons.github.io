...
| [LmcRbacRoleProviderDoctrineORM](https://github.com/LM-Commons/lmc-rbac-role-provider-doctrine-orm) | ![Packagist Version](https://img.shields.io/packagist/v/lm-commons/lmc-rbac-role-provider-doctrine-orm?label=%20)| ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.github.com%2Frepos%2Flm-commons%2Flmc-rbac-role-provider-doctrine-orm%2Fproperties%2Fvalues&query=%24%5B%3A1%5D.value&label=%20&color=green)|
